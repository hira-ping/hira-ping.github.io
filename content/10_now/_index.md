...
## Current Focus
 ...
 - **差分プライバシーやプライバシー保護機械学習:** プライバシー法制と技術の間のギャップを技術で埋められないか問題意識とつながっている。
 - **数学の学習・復習**
	 - **数学:** 過去にまとめたノートを転記しながら、学生時代に勉強したが忘れてしまったことを再構成している。ここでは主に、理論の根幹となる部分に絞ってまとめている。
	 - **数学 実践コレクション:** 命題・定理・公式・テクニックなどを整理したもの。一回証明したことは道具として使えるよう、ここにストックしておく。計算問題をスムーズに解けるようになることが主な目的。覚えておくと役立つ面白い知識なども溜め込んでいく。
 - **Nand2Tetris:** コンピューターの挙動を低レイヤーから解きほぐして理解することを目指している。
    - （ミニマムな汎用コンピュータを自作して小規模なゲームを作って遊びたい。）
...
### 📅 To Do (Want to Do)
- **数学の学習・復習**
  - [ ] 微積分の諸定理を[実践コレクション]に追加 (Entry: 2026-08-19)
    - 連続関数以外の可積分性（単調関数 / 区分的に連続な関数）
    - 置換積分と部分積分 / 広義積分 / 積分の平均値の定理
  - [ ] 微積分の計算テクニックを[実践コレクション]に追加 (Entry: 2026-08-19)
  - [ ] 無限次元ベクトル空間の基底の存在の証明 (Entry: 2026-08-23)
  - 代数
  - [ ] 形式的冪級数環に至るまでの代数学→母関数 (Entry: 2026-08-25)
  - [ ] 線形代数の復習（理論）
  - [ ] アインシュタイン記法による行列計算のノートを作成 (Entry: 2026-08-26)
  - [ ] 線形代数の実践ノートに書くこと
	  - 2次正方行列の公式いろいろ（逆行列、固有値の簡単な計算方法）
	  - 上三角行列の固有値
	  - 行列式は固有値の積
  - 解析
  - [ ] 1変数の微積分 (解析学-1)の復習 (Entry: 2026-08-11)
  - [ ] 位相空間論の復習 (Entry: 2026-08-11)
  - [ ] 多変数関数の微積分 (解析学-2)の復習 (Entry: 2026-08-11)
  - [ ] 測度論 (解析学-7くらい)の学習 (Entry: 2026-08-11)
  - 専門
