...
### 📅 To Do (Want to Do)
- **数学の学習・復習**
  - [ ] 微積分の諸定理を[実践コレクション]に追加 (Entry: 08-19)
    - 連続関数以外の可積分性（単調関数 / 区分的に連続な関数）
    - 置換積分と部分積分 / 広義積分 / 積分の平均値の定理
  - [ ] 微積分の計算テクニックを[実践コレクション]に追加 (Entry: 08-19)
  - [ ] 無限次元ベクトル空間の基底の存在の証明 (Entry: 08-23)
  - [ ] 形式的冪級数環に至るまでの代数学→母関数 (Entry: 08-25)
  - [ ] アインシュタイン記法による行列計算のノートを作成 (Entry: 08-26)

### 🎉 Recent Done
- [x] 一様連続性 → ハイネ＝カントールの定理の証明のノートを追加 (Done: 2026-08-20)
